...
// HealthCheck summarises per-platform runtime dependencies the frontend
...
// HealthIssue is a single detected problem plus guidance for fixing it.
...
// RunHealthCheck evaluates the current platform and returns a summary the
...
func RunHealthCheck() HealthCheck {
	hc := HealthCheck{
		OK:      true,
...
func checkGStreamer() (HealthIssue, bool) {
